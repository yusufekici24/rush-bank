    ...
    public class UIManager : MonoBehaviour
    {
        ...
        private Color GetRequestColor(CustomerRequestKind requestKind)
        {
            return requestKind switch
            {
                ...
                CustomerRequestKind.MobileActivation => depositColor,
                CustomerRequestKind.PhilanthropistCustomer => depositColor,
                CustomerRequestKind.PassbookPrinting => depositColor,
                CustomerRequestKind.CardBlockRemoval => depositColor,
                CustomerRequestKind.WireTransfer => depositColor,
                CustomerRequestKind.InsuranceReferral => depositColor,
                CustomerRequestKind.ScammerCustomer => depositColor,
                CustomerRequestKind.BarutCustomer => withdrawColor,
        ...
        private static string GetRequestShortLabel(CustomerRequestKind requestKind)
        {
            return requestKind switch
            {
                ...
                CustomerRequestKind.MobileActivation => "SMS",
                CustomerRequestKind.PhilanthropistCustomer => "DON",
                CustomerRequestKind.CardBlockRemoval => "C",
                CustomerRequestKind.CashWithdrawDeposit => "$",
                CustomerRequestKind.WireTransfer => "WT",
                CustomerRequestKind.InsuranceReferral => "INS",
                CustomerRequestKind.ScammerCustomer => "ID",
                CustomerRequestKind.BarutCustomer => "!!",
